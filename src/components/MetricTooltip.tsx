  ...
  return (
    <div className="relative inline-flex items-center ml-1 z-30">
      <button
        ...
        className="p-0.5 rounded-full text-slate-400 hover:text-[#6D19E8] dark:hover:text-[#FF8A00] transition-colors cursor-pointer"
      ...
      {isOpen && (
        ...
        >
          ...
          {formula && (
            <div className="p-1.5 rounded-xl bg-slate-50 dark:bg-[#12151D] border border-slate-100 dark:border-[#292E38] font-mono text-[10px] text-[#6D19E8] dark:text-[#FF8A00] mb-1.5">
              {formula}
            </div>
          )}
          {interpretation && (
